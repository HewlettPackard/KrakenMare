...
# derived from Confluent work available at https://github.com/confluentinc/cp-demo
#
...
# We make a full set of secrets that a java application would use for mosquitto even though we don't use most of them.
for i in broker-1 broker-2 broker-3 schemaregistry client connect mosquitto elastic
do
	echo "------------------------------- $i -------------------------------"
