...
docker run --rm --volume $BD_HOME:/playbooks/ --network=host ansible ansible-playbook /playbooks/bdu-client-playbook.yml --inventory /playbooks/hosts --forks 100

docker run --rm --volume $BD_HOME:/playbooks/  --network=host ansible ansible-playbook /playbooks/ansible-clock.yml --inventory /playbooks/hosts --forks 100 

docker run --rm --volume $BD_HOME:/playbooks/  --network=host ansible ansible-playbook /playbooks/swarm_exit.yml --inventory /playbooks/hosts --forks 100 

docker run --rm --volume $BD_HOME:/playbooks/  --network=host ansible ansible-playbook /playbooks/swarm_init.yml --inventory /playbooks/hosts --forks 100
