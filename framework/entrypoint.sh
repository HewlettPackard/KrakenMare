...
/tmp/wait-for --timeout=240 redis:6379 \
    ...
    && /tmp/wait-for --timeout=240 schemaregistry:8081 -- java -cp target/framework-0.0.1-SNAPSHOT-jar-with-dependencies.jar -XX:+HeapDumpOnOutOfMemoryError com.hpe.krakenmare.Main &> /tmp/logs
